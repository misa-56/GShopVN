                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="d-flex">
                                    <form action="/add-cart" method="post">
                                        ...
                                        <div>
                                            <p class="font-weight-bold">Nhập thông tin bổ sung &nbsp;<span class="text-danger">*</span></p>
                                            <div class="form-group">
                                                <input class="form-control" type="text" placeholder="Email/user tài khoản" id="acc_email" name="acc_email" value="" autocomplete="off" required>
                                            </div>

                                            @if($product->account_password == 1)
                                            <div class="form-group">
                                                <input class="form-control" type="text" placeholder="Password tài khoản" id="acc_password" name="acc_password" value="" autocomplete="off" required>
                                            </div>
                                            @endif
                                            <hr>
                                        </div>
                                        @endif
                                            ...
                                            <div class="d-flex mb-3">
                                                ...
                                                <input class="mr-2 border border-info rounded d-none" type="text" style="width: 50px;"
                                                ...
                                                <button type="submit"
                                                    class="btn btn-light border border-info "
                                                    @if($product->stock != 1)
                                                    disabled
                                                    @endif>
