                    ...
                    <div class="row shadow">
                        ...
                        <div class="col-md-8 bg-white  rounded-left p-3">
                            ...
                            <div class="title">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center text-right text-muted">
                                        {{ count(Session::get('carts')) }} items</div>
                                </div>
                            </div>
                            @php $total = 0; @endphp
                            ...
                            @foreach ($products as $key => $product)
                                ...
                                <div class="row m-0 border-top">
                                    <div class="row m-0  align-items-center py-3 w-100">
                                        <div class="col-md-2 col-4 px-1"><img class="img-fluid" style="width: 8rem;"
                                                src="{{ $product->thumb }}"></div>
                                        ...
                                        <div class="col px-1 text-danger my-2 mx-3">
                                            <sup>₫</sup>{{ number_format($priceEnd, 0, '', '.') }}<span class="close "><a
                                                    class=" text-decoration-none text-dark"
                                                    href="/carts/delete/{{ $product->id }}">&#10005;</a></span></div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="d-flex justify-content-between border-top pt-4">
                                ...
                                <div class="back-to-shop mt-4"><a class="text-decoration-none text-secondary"
                                        href="/san-pham">&leftarrow;Trở lại shop</a></div>

                                <button type="submit" formaction="/update-cart" class="btn btn-info">Cập nhật Giỏ hàng
                                </button>
                                @csrf
                            </div>
                                    ...
                                    <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                        ...
                                        <div class="p-t-15">
                                            ...
                                            @if (Auth::check())
                                                <div class="m-1">
                                                    <input
                                                        style="border: 1px solid rgba(0, 0, 0, 0.137); background-color: rgb(247, 247, 247);"
                                                        class=" " type="text" name="name"
                                                        value="{{ Auth::user()->name }}" placeholder="Tên Khách Hàng">
                                                </div>

                                                <div class="m-1">
                                                    <input
                                                        style="border: 1px solid rgba(0, 0, 0, 0.137); background-color: rgb(247, 247, 247);"
                                                        class=" " type="text" name="phone"
                                                ...
                                                <div class="m-1">
                                                    <input
                                                        ...
                                                        value="{{ Auth::user()->email }}" placeholder="Email Liên Hệ">
                                                </div>

                                                <div class="m-1">
                                                    <textarea style="border: 1px solid rgba(0, 0, 0, 0.137); background-color: rgb(247, 247, 247);" class=" w-100"
                                                        name="content" placeholder="Ghi chú đơn hàng"></textarea>
                                                </div>
                                            @else
                                                <div class="m-1">
                                                    <input
                                            ...
                                            <div>
                                                ...
                                                <img class="mx-2" src="/template/images/momo.png" alt="Momo"
