    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                ...
                '<button style=" border:1px solid rgba(0,0,0,.09); min-width: ${buttonsWidth}; height:2rem;" class="rounded-left bg-white btn-decrement ${buttonsClass} btn-minus" type="button">${decrementButton}</button>' +
                '<input type="text" inputmode="decimal" style=" border:1px 0 1px 0 solid rgba(0,0,0,.09); text-align: ${textAlign}; max-width: 2rem; height:2rem; font-size: 15px; padding:0;" class="form-control form-control-text-input"/>' +
                '<button style=" border:1px solid rgba(0,0,0,.09); min-width: ${buttonsWidth}; height:2rem;" class="rounded-right bg-white btn-increment ${buttonsClass} btn-plus" type="button">${incrementButton}</button>' +
                '</div>'
        }
